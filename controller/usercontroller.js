...
//         res.render("admin/html/admin", {user, payments, notifications,
//             totalAmount,
//             totalsub});
//           }
...
//                 package,
//                 image: imageURL,
//                 referredBy: referredBy ? referredBy._id : null // Assign the user who referred
//             });
...
//                 { _id: referredBy._id },
//                 {
//                     $set: { referralToken: null, referralTokenExpiry: null },
//                     $inc: { referralCount: 1 }, // Increment the referral count
//                     $push: {
//                         referredUsers: {
//                             _id: newUser._id,
//                             fullname: newUser.fullname,
...
//         const referredBy = await User.findOne({
//             referralToken: referralToken,
//             referralTokenExpiry: { $gte: Date.now() } // Check if the token is still valid
//         }).select('fullname email image'); // Select fields to include
...
//     // Function to fetch and build the user network
//     const getNetwork = async (user) => {
//         const network = [];
//         for (const ref of user.referredUsers) {
//             const referrals = await getNetwork(ref); // Recursive call
//             network.push({
//                 _id: ref._id,
//                 fullname: ref.fullname,
//                 email: ref.email,
//                 image: ref.image,
//                 referredUsers: referrals // Recursive structure
//             });
//         }
//         return network;
//     };

//     // Fetch the initial user and populate their referred users
//     const user = await User.findById(userId)
...
//     // Build and return the user network
//     return {
//         _id: user._id,
//         fullname: user.fullname,
//         email: user.email,
//         image: user.image,
//         referredUsers: await getNetwork(user) // Pass the user object to get the full network
//     };
// };
